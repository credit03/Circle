package com.guoyi.circle.ui.dialog;
...
public class CommentDialog extends Dialog implements
    ...
    private CommentBean mCommentsBean;
    private int mCirclePosition;


    public CommentDialog(Context context, CirclePresenter presenter,
                         CommentBean commentItem, int circlePosition) {
        super(context, R.style.comment_dialog);
        mContext = context;
        this.mPresenter = presenter;
        this.mCommentsBean = commentItem;
    ...
    private void initView() {
        ...
        if (mCommentsBean != null
                && UserDao.getInstance().getUserId().equals(
                mCommentsBean.getUser().getId() + "")) {
        ...
        switch (v.getId()) {
            case R.id.copyTv:
                if (mCommentsBean != null) {
                    ...
                    clipboard.setText(mCommentsBean.getContent());
                }
                dismiss();
                break;
            case R.id.deleteTv:
                if (mPresenter != null && mCommentsBean != null) {
                    mPresenter.deleteComment(mCirclePosition, mCommentsBean.getId());
                }
                dismiss();
                break;
            default:
